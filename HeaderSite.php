...
<html lang="en">
  ...
  <head>
    ...
    <title>Hair Care & Love | Productos & Accesorios para el Cabello</title>
  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="index.php"><h2>Hair Care<em> & Love</em></h2></a>
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="oferta.php">Ofertas</a></li>
